                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input internal-shadow" id="option1" value="ipaddress">
                            <label class="form-check-label" for="option1">IP Address</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input internal-shadow" id="option2" value="s3bucket">
                            <label class="form-check-label" for="option2">S3 Bucket</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input internal-shadow" 
            ...
            <div class="row col-lg-12">
                ...
                <div class="col-lg-2">
                    <button type="button" class="btn rounded-pill shadow btn-blue"
                        data-bs-toggle="tooltip" data-bs-placement="top" title="IP address is the default scan model, 
                                                                        please use the filters to select another.">
