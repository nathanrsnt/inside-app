            ...
            <div class="modal-content">
                ...
                <div class="container">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input internal-shadow" id="option1" value="-sV" checked>
                                <label class="form-check-label" for="option1">-sV</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input internal-shadow" id="option2" value="-sn">
                                <label class="form-check-label" for="option2">-sn</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input internal-shadow" id="option3" value="-iR" checked>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input internal-shadow" id="option5" value="-A" checked>
